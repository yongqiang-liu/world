export const enum Define {
  ITEM_TYPE_ARMOR_HEAD = 0,
  ITEM_TYPE_ARMOR_CLOTHES = 1,
  ITEM_TYPE_ARMOR_TROUSERS = 2,
  ITEM_TYPE_ARMOR_SHOULDER = 3,
  ITEM_TYPE_ARMOR_WAIST = 4,
  ITEM_TYPE_ARMOR_BACK = 5,
  ITEM_TYPE_ARMOR_SHOES = 6,
  ITEM_TYPE_ARMOR_HAND = 7,
  ITEM_TYPE_ARMOR_NECKLACE = 8,
  ITEM_TYPE_ARMOR_RING = 9,
  ITEM_TYPE_ARMOR_AMULET = 10,
  ITEM_TYPE_ARMOR_TRANSPORT = 11,
  ITEM_TYPE_ARMOR_FASHION = 12,
  ITEM_TYPE_WEAPON_ONEHAND_SWORD = 13,
  ITEM_TYPE_WEAPON_TWOHAND_SWORD = 14,
  ITEM_TYPE_WEAPON_ONEHAND_BLADE = 15,
  ITEM_TYPE_WEAPON_TWOHAND_BLADE = 16,
  ITEM_TYPE_WEAPON_ONEHAND_HEAVY = 17,
  ITEM_TYPE_WEAPON_TWOHAND_HEAVY = 18,
  ITEM_TYPE_WEAPON_TWOHAND_STAFF = 19,
  ITEM_TYPE_WEAPON_TWOHAND_LANCE = 20,
  ITEM_TYPE_WEAPON_ONEHAND_CROSSBOW = 21,
  ITEM_TYPE_WEAPON_TWOHAND_CROSSBOW = 22,
  ITEM_TYPE_WEAPON_TWOHAND_BOW = 23,
  ITEM_TYPE_WEAPON_ONEHAND_HAND = 24,
  ITEM_TYPE_TASK = 25,
  ITEM_TYPE_BATTLE_USE = 26,
  ITEM_TYPE_ANYTIME_USE = 27,
  ITEM_TYPE_NOT_BATTLE_USE = 28,
  ITEM_TYPE_BUILD_MATERIAL = 29,
  ITEM_TYPE_GEM = 30,
  ITEM_TYPE_SKILL_BOOK = 31,
  ITEM_TYPE_PET = 32,
  ITEM_TYPE_SPECEAIL = 33,
  ITEM_TYPE_WEAPON_BALL = 34,
  ITEM_TYPE_WEAPON_ONEHAND_GUN = 35,
  ITEM_TYPE_WEAPON_TWOHAND_GUN = 36,
  ITEM_TYPE_OTHER = 37,
  ITEM_TYPE_ONE_SWORD = 100,
  ITEM_TYPE_ONE_BLADE = 101,
  ITEM_TYPE_NULL = -1,
  BALL_WEAPON_ID_AREA = Define.ITEM_TYPE_WEAPON_ONEHAND_HAND + 1,
  BALL_WEAPON_ID_ONEHAND_GUN = Define.ITEM_TYPE_WEAPON_ONEHAND_HAND + 2,
  BALL_WEAPON_ID_TWOHAND_GUN = Define.ITEM_TYPE_WEAPON_ONEHAND_HAND + 3,
}
